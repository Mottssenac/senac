    ...
    <div class="container">
        ...
        <form action="dados.php" method="post">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-2">
                    <input type="number" class="form-control" name="num" id="" placeholder="Número">
                </div>
                <!-- terceira coluna .... -->
                <div class="col-md-3">
            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="cep" id="" placeholder="CEP">
                </div>
                <div class="col-md-6">
            ...
            <!-- quarta linha -->
             <div class="row mt-2"> 
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" name="rg" id="" placeholder="Digite o RG">
                </div>
                <div class="col-md-4">
                    <input type="text" class="form-control" name="cpf" id="" placeholder="Digite o CPF">
                </div>
             </div>
            <!-- quinta linha -->
             <div class="row mt-2">
